...
@interface TalentShowCollectionCell()
...
@end
@implementation TalentShowCollectionCell
...
{
    if (!_showImageView) {
        _showImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, viewWidth(self), 160*kScreenFactor)];
    }
...
//设置数据
- (void)resetRoomsModel:(LiveKindRooms *)model
{
    NSString *urlString;
