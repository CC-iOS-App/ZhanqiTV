...
- (void)resetHotModel:(EntertainmentHotRoomRooms *)model//热门直播
{
    NSString *urlString;
...
- (void)resetOtherModel:(EntertainmentOtherList *)model//其它直播
{
    NSString *urlString;
    if (![model.spic isEqualToString:@""]) {//判断bpic有没图片地址，没有就用spic
        urlString = model.spic;
...
- (void)resetChangeModel:(EntertainmentChangedRooms *)model//百变主播
{
    NSString *urlString;
    if (![model.spic isEqualToString:@""]) {//判断bpic有没图片地址，没有就用spic
        urlString = model.spic;
