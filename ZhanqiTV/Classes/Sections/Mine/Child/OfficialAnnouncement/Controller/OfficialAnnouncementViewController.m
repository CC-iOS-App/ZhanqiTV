...
{
    if (!_scrollView) {
        _scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, self.topView.bottom, kScreen_width, kScreen_height-self.topView.height-kNavigationHeight)];
        ...
        //创建5个tableview存储信息数据
        for (int i = 0; i < 5; i++) {
            OfficialAnnoucementTableView *tableView = [[OfficialAnnoucementTableView alloc]initWithFrame:CGRectMake(i*_scrollView.width, 0, _scrollView.width, _scrollView.height) style:UITableViewStylePlain];
