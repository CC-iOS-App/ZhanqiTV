...
@interface HomeViewController ()<HomeNavDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
...
{
    if (!_navView) {
        _navView = [[HomeNavView alloc]initWithFrame:CGRectMake(0, 0, kScreen_width, 64)];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.navView.frame), kScreen_width, kScreen_height-kNavigationHeight-kTabbarHeight) collectionViewLayout:layout];
